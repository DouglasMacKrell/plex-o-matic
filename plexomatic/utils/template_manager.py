...
from typing import Dict, Optional, Union, Any, List, ClassVar
...
class TemplateManager:
    ...
    def get_template(
        self, template_type: TemplateType, name: str, fallback: bool = False
    ) -> str:
    ...
    def load_templates_from_directory(self) -> None:
        ...
        for filename in os.listdir(self.templates_dir):
            ...
            try:
                template_type = next(
                    t for t in TemplateType if t.value == type_str
                )
