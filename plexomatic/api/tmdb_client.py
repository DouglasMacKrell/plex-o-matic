...
class TMDBClient:
    ...
    def search_tv(self, query: str, first_air_date_year: Optional[int] = None) -> List[Dict[str, Any]]:
    ...
    def get_tv_details(self, tv_id: int, append_to_response: Optional[str] = None) -> Dict[str, Any]:
    ...
    def get_poster_url(self, poster_path: str, size: str = "original") -> str:
        ...
        if size not in available_sizes:
            size = "original"
            logger.warning(f"Requested poster size '{size}' not available, using 'original' instead")
