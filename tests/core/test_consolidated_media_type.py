...
@pytest.mark.parametrize("enum_value, expected_string", [
...
def test_serialization():
    ...
    assert json.dumps(data, default=lambda x: x.value if isinstance(x, MediaType) else x) == json_str


@pytest.mark.parametrize("string_value, expected_enum", [
...
@pytest.mark.parametrize("legacy_value, source, expected_enum", [
...
@pytest.mark.parametrize("enum_value, expected_core_value, expected_fetcher_value", [
