...
class TestCalculateChecksum:
    ...
    def test_calculate_checksum(self, temp_file):
...
class TestRenameFile:
    ...
    def test_basic_rename(self, temp_file):
    ...
    def test_rename_with_backup(self, temp_file, mock_backup_system):
    ...
    def test_rename_to_existing_directory(self, temp_file):
    ...
    @patch("shutil.move")
    def test_rename_error_handling(self, mock_move, temp_file):
...
class TestRollback:
    ...
    def test_successful_rollback(self, temp_file, mock_backup_system):
    ...
    def test_rollback_missing_file(self, mock_backup_system):
    ...
    def test_rollback_invalid_operation(self, mock_backup_system):
    ...
    def test_rollback_incomplete_operation(self, mock_backup_system):
    ...
    def test_rollback_checksum_mismatch(self, temp_file, mock_backup_system):
    ...
    def test_rollback_checksum_error(self, temp_file, mock_backup_system):
    ...
    @patch("shutil.move")
    def test_rollback_move_error(self, mock_move, temp_file, mock_backup_system):
