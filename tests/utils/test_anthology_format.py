...
class TestAnthologyFormatting:
    ...
    @pytest.mark.skip(
        reason="Function signature mismatch: get_preview_rename doesn't accept use_llm parameter"
    )
    ...
    def test_anthology_format_with_spaces(self, mock_process):
        ...
        mock_info = {
            ...
            "segment_map": {10: "The Summit", 11: "The Housesitter", 12: "Keep Smiling"},
        }
    ...
    @pytest.mark.skip(
        reason="Function signature mismatch: process_anthology_episode doesn't accept original_path parameter"
    )
