...
class TestMetadataEpisodeIntegration:
    ...
    def test_metadata_fetching_for_special_episodes(self):
        ...
        episodes_data = [
            {"id": 1001, "airedSeason": 1, "airedEpisodeNumber": 1, "episodeName": "Regular Episode"},
        ...
        with patch('plexomatic.metadata.fetcher.TVDBClient', return_value=mock_tvdb_client):
            ...
            specials = [e for e in mock_tvdb_client.get_episodes_by_series_id.return_value 
                       if e["airedSeason"] == 0]
    ...
    def test_fetch_episode_metadata(self):
        ...
        manager.fetch_metadata = MagicMock(return_value={
            "id": "tvdb:12345",
            "title": "Test Show",
            "overview": "A test show",
            "year": 2020
